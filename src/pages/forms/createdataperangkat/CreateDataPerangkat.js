...
import s from "./createdataperangkat.module.scss";
        ...
        <Row className="py-5 justify-content-center">
          <Col lg={12} className="text-center">
            <h1 className="page-title">
              Create Data <span className="fw-semi-bold"> Perangkat</span>
            </h1>
          </Col>
          <Col lg={7}>
            <Widget refresh collapse className="px-5">
              <Form onSubmit={this.doCreateDataArea} className="mt-4">
                ...
                <FormGroup row>
                  <Label for="serialnumber-input">Nomor Seri</Label>
                  <input
                    name="nomorseri"
                    onChange={this.handleChange}
                    className="form-control"
                ...
                <FormGroup row>
                  <Label for="tipe-input">Tipe</Label>
                  <input
                    name="tipe"
                    onChange={this.handleChange}
                    className="form-control"
                ...
                <FormGroup row>
                  <Label for="parent-input">Parent</Label>
                  <input
                    name="parent"
                    onChange={this.handleChange}
                    className="form-control"
                ...
                <FormGroup row>
                  <Label for="lastupdate-input">Last Update</Label>
                  <input
                    name="code"
                    onChange={this.handleChange}
                    className="form-control"
                ...
                <FormGroup row>
                  <Label for="valve-input">Valve</Label>
                  <input
                    name="valve"
                    onChange={this.handleChange}
                    className="form-control"
                ...
                <FormGroup row>
                  <Label for="signal-input">Signal</Label>
                  <input
                    name="signal"
                    onChange={this.handleChange}
                    className="form-control"
                ...
                <FormGroup row>
                  <Label for="battery-input">Battery Voltage</Label>
                  <input
                    name="batteryvoltage"
                    onChange={this.handleChange}
                    className="form-control"
                ...
                <FormGroup row>
                  <Label for="wilayah-input">Wilayah Area</Label>
                  <input
                    name="wilayaharea"
                    onChange={this.handleChange}
                    className="form-control"
