...
import s from "./createdatauser.module.scss";
...
class CreateDataUser extends React.Component {
  state = {
    code: "",
    name: "",
    createStatus: null,
        ...
        <Row className="py-5 justify-content-center">
          <Col lg={12} className="text-center">
            <h1 className="page-title">
              Create Data <span className="fw-semi-bold"> User</span>
            </h1>
          </Col>
          <Col lg={7}>
